# Guide til at få GitHub Pages til at virke for DSA-siden

## Problemer der er rettet:
✅ Billedreferencen er rettet fra `ChatGPT Image 19. nov. 2025, 13.04.37.png` til `Baggrundsbillede.png`
✅ `index.html` er oprettet (GitHub Pages kræver denne filnavn)
...
3. Navngiv repository (fx "dsa-eud" eller "dansk-som-andetsprog")
...
Åbn PowerShell eller Terminal i mappen `DSA` og kør:
...
# Lav første commit
git commit -m "Første commit - DSA på EUD"
...
✅ `index.html` skal være i roden af repository (✓ nu oprettet)
...
- Tjek browser console for fejl (F12 → Console)
